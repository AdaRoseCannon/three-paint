...
class PaintRenderer {
  constructor(parameters) {
    console.log("PaintRenderer", REVISION);
    ...
    var _this = this,
      ...
      _canvasWidth = parameters.size.width,
      _canvasHeight = parameters.size.height,
    ...
    this.setClearColorHex = function(hex, alpha) {
      console.warn(
        "PaintRenderer: .setClearColorHex() is being removed. Use .setClearColor() instead."
      );
    ...
    this.render = function(scene, camera) {
      if (camera.isCamera === undefined) {
        console.error(
          "PaintRenderer.render: camera is not an instance of Camera."
        );
        return;
      }
...
export { PaintRenderer, SpriteCanvasMaterial };
